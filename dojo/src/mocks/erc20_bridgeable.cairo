...
mod erc20_bridgeable_component {
    ...
    use pistols::mocks::erc20_balance::erc20_balance_component as erc20_balance_comp;
    use pistols::mocks::erc20_metadata::erc20_metadata_component as erc20_metadata_comp;
    use pistols::mocks::erc20_mintable::erc20_mintable_component as erc20_mintable_comp;
    use pistols::mocks::erc20_burnable::erc20_burnable_component as erc20_burnable_comp;
